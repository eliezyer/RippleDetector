...
SPWRsDetectorEditor::SPWRsDetectorEditor(GenericProcessor* parentNode, bool useDefaultParameterEditors=true)
...
SPWRsDetectorEditor::~SPWRsDetectorEditor()
{

}

void SPWRsDetectorEditor::updateSettings()
{
...
void SPWRsDetectorEditor::comboBoxChanged(ComboBox* c)
{
...
void SPWRsDetectorEditor::buttonEvent(Button* button)
{
...
void SPWRsDetectorEditor::addDetector()
{
    std::cout << "Adding detector" << std::endl;

    SPWRsDetector* sd = (SPWRsDetector*) getProcessor();

    int detectorNumber = interfaces.size()+1;

    SPWRsInterface* di = new SPWRsInterface(sd, backgroundColours[detectorNumber%5], detectorNumber-1);
...
void SPWRsDetectorEditor::saveCustomParameters(XmlElement* xml)
{

    xml->setAttribute("Type", "SPWRsDetectorEditor");
...
void SPWRsDetectorEditor::loadCustomParameters(XmlElement* xml)
{
...
SPWRsInterface::SPWRsInterface(SPWRsDetector* sd, Colour c, int id) :
...
SPWRsInterface::~SPWRsInterface()
{

}

void SPWRsInterface::comboBoxChanged(ComboBox* c)
{
...
void SPWRsInterface::buttonClicked(Button* b)
{
...
void SPWRsInterface::updateChannels(int numChannels)
{
...
void SPWRsInterface::paint(Graphics& g)
{
...
void SPWRsInterface::setPhase(int p)
{
...
void SPWRsInterface::setInputChan(int chan)
{
...
void SPWRsInterface::setOutputChan(int chan)
{
...
void SPWRsInterface::setGateChan(int chan)
{
...
int SPWRsInterface::getInputChan()
{
    return inputSelector->getSelectedId()-2;
}

int SPWRsInterface::getOutputChan()
{
    return outputSelector->getSelectedId()-2;
}

int SPWRsInterface::getGateChan()
{

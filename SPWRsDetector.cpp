...
SPWRsDetector::SPWRsDetector()
    : GenericProcessor("SPWRs Detector"), activeModule(-1),
...
AudioProcessorEditor* SPWRsDetector::createEditor()
{
    return editor = new SPWRsDetectorEditor(this, true);
...
void SPWRsDetector::setActiveModule(int i)
{
    activeModule = i;
...
void SPWRsDetector::setParameter(int parameterIndex, float newValue)
{
...
void SPWRsDetector::updateSettings()
{

}

bool SPWRsDetector::enable()
{
    return true;
}

void SPWRsDetector::handleEvent(int eventType, MidiMessage& event, int sampleNum)
{
...
void SPWRsDetector::estimateFrequency()
{}
